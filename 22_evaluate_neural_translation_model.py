...
def evaluate_model(model, tokenizer, sources, raw_dataset):
        ...
        for i, source in enumerate(sources):
                ...
                ll = []
                for j in source:
                        ll.append(word_for_id(j, tokenizer))
                print(ll)
...
# Load datasets
dataset = load_sentences('./crossvalidation/newProverb2_jieba_v5_0-both.pkl')
train = load_sentences('./crossvalidation/newProverb2_jieba_v5_0-train.pkl')
test = load_sentences('./crossvalidation/newProverb2_jieba_v5_0-test.pkl')
