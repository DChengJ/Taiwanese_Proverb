...
tf.app.flags.DEFINE_string('dataset_path', 'crossvalidation/newProverb2_jieba_v1_0-both.pkl', 'all dataset of path to directory')
tf.app.flags.DEFINE_string('train_path', 'crossvalidation/newProverb2_jieba_v1_0-1-train.pkl', 'train dataset of path to directory')
tf.app.flags.DEFINE_string('test_path', 'crossvalidation/newProverb2_jieba_v1_0-1-test.pkl', 'test dataset of path to directory')
