...
tf.app.flags.DEFINE_integer('window', 5, 'The maximum distance between the current and predicted word within a sentence.')
...
def main(argv):   
    ...
    output_path = "%s/%s.model.bin" % (output_path, dim_size)
