...
tf.app.flags.DEFINE_string('data_path', './data/newProverb2_v2_0.csv', 'path to directory')
tf.app.flags.DEFINE_string('dict_path', './tools/extra_dict/dict3.txt', 'dict path to directory')
tf.app.flags.DEFINE_string('output_path', './pkl_data/newProverb2_jieba_v2_3.pkl', 'output path to directory')
